...
<body>
	...
	<div class="content">
		...
		A solar diagram shows the position (and in general, the trajectory) of the <a href="http://en.wikipedia.org/wiki/The_sun">sun</a> at a given time of day, for a given day of the year. It answers the questions:
		<ul>
